from transformers import pipeline # lib by HF. func for easy use of pre-trained models
import warnings
...
# device=0: Uses the GPU, max_length=512: Limits the input text length to 512 tokens. truncation=True: Truncates texts longer than max_length
